document.addEventListener("DOMContentLoaded", () => {
  ...
  const rightPanelDown = document.querySelector(".right-panel-down"); // 選取整個績效指標區域
